...
class Application:
    ...
    #     self.model = load_model('/home/vikas/Downloads/Sign-Language-To-Text-and-Speech-Conversion-master/cnn8grps_rad1_model.h5')
    ...
    def __init__(self):
        ...
        self.speak_engine = pyttsx3.init()
        self.speak_engine.setProperty('rate', 150)  # Speed of speech
        voices = self.speak_engine.getProperty('voices')
        self.speak_engine.setProperty('voice', voices[1].id)  # Select a female voice if available
    ...
    def speak_fun(self):
        text = self.get_text_to_speak()
        self.speak_engine.say(text)
        self.speak_engine.runAndWait()

    def get_text_to_speak(self):
        # Replace with your logic to get the text
        return "Hello, how are you?"

    def clear_fun(self):
        # Your clear function logic
        pass
    ...
    def video_loop(self):
        try:
            ...
            if hands and isinstance(hands[0], list) and len(hands[0]) > 0:
                print(" --------- lmlist=", hands[0])
                hand = hands[0][0]  # Access the first hand from the list
                if isinstance(hand, dict) and 'bbox' in hand:
                    ...
                    print(" ", self.ccc)
                    self.ccc += 1
                    if handz and isinstance(handz[0], list) and len(handz[0]) > 0:
                        hand = handz[0][0]
